      ...
      >
        <div className=' flex mt-20 '>
          ...
          <header>
            ...
            <h1 className="font-poppins-Bold  text-6xl  xl:text-7xl text-primary mb-4 [text-shadow:0px_4px_4px_#00000080]">
              DESIGNER
            </h1>
            <div className="pt-7 flex gap-5 ">
              <Button className="text-light px-8 py-2.5  [text-shadow:0px_4px_4px_#00000080]  font-poppins-Bold">Hire me</Button>
              <Button className="text-light bg-dark px-8 py-2.5 font-poppins-Bold  [text-shadow:0px_4px_4px_#00000080]">Download CV
